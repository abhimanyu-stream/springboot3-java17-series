...
public class DataSourceConfiguration {
 ...
 /*   @Bean(name = "readDataSource")
   ...
   // @Bean(name = "readEntityManagerFactory") Session Factory try to find EntityManagerFactory bean with name entityManagerFactory, so below line is ok working
   /*@Bean(name = "entityManagerFactory")
    public EntityManagerFactory readEntityManagerFactory(@Qualifier("readDataSource") DataSource dataSource) throws SQLException {
        ...
        LocalContainerEntityManagerFactoryBean factory = new LocalContainerEntityManagerFactoryBean();
        factory.setJpaVendorAdapter(vendorAdapter);
        factory.setPackagesToScan("com.stream.cqrs.order.query.entities");
        factory.setDataSource(dataSource);
   ...
   /* @Bean(name ="readEntityManager")
    ...
    public PlatformTransactionManager writeTransactionManager(@Qualifier("writeEntityManagerFactory") EntityManagerFactory entityManagerFactory) throws SQLException {
