...
public class DataSourceConfiguration {
    ...
    public EntityManagerFactory writeEntityManagerFactory(@Qualifier("writeDataSource") DataSource dataSource) throws SQLException {
        ...
        factory.setPackagesToScan("com.stream.cqrswritedbreaddb.write_command.model");
   ...
   @Bean(name = "entityManagerFactory")
    public EntityManagerFactory readEntityManagerFactory(@Qualifier("readDataSource") DataSource dataSource) throws SQLException {
        ...
        LocalContainerEntityManagerFactoryBean factory = new LocalContainerEntityManagerFactoryBean();
        factory.setJpaVendorAdapter(vendorAdapter);
        factory.setPackagesToScan("com.stream.cqrswritedbreaddb.read_query.model");
        factory.setDataSource(dataSource);
    ...
    public PlatformTransactionManager writeJpaTransactionManager(@Qualifier("writeEntityManagerFactory") EntityManagerFactory entityManagerFactory) {
    ...
    public PlatformTransactionManager readJpaTransactionManager(@Qualifier("entityManagerFactory") EntityManagerFactory entityManagerFactory) {
        JpaTransactionManager txManager = new JpaTransactionManager();
        txManager.setEntityManagerFactory(entityManagerFactory);
        return txManager;
    }
